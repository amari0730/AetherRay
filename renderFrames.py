...
for frame in range(0, 11):
    ...
    cur_lines = lines
    cur_lines[1] =  ' scene = /Users/mohammadhijaz/Desktop/cs-1230/final-project/jsonFrames/' + 'frame' + str(frame) + ".json"
    cur_lines[2] =  ' output = /Users/mohammadhijaz/Desktop/cs-1230/final-project/outputFrames/' + 'frame' + str(frame) + ".png"
    # print(cur_line)
    ini_to_str = ""
...
for frame in range(0, 11):
    ...
    result = subprocess.run([executable_path, cur_argument], capture_output=True, text=True)
    # print(result.stderr)
